...
public class Main {
	public static void main(String[] args) {
		...
		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("com/xmlconfiguration/dependencyinjection/literalvalues/applicationContext.xml");
